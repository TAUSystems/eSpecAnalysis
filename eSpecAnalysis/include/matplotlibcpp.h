...
//New addition for fixing 3d surface plot
                  ...
                  const long fig_number=0)
{
  ...
  PyObject *python_colormap_viridis = PyObject_GetAttrString(
      detail::_interpreter::get().s_python_colormap, "viridis");

  PyObject* python_colormap_magma = PyObject_GetAttrString(
      detail::_interpreter::get().s_python_colormap, "magma");

  PyDict_SetItemString(kwargs, "cmap", python_colormap_magma);
...
template<typename Numeric>
inline void set_aspect(Numeric ratio, const long fig_number=1)
{
    detail::_interpreter::get();
    ...
    if (!gca) throw std::runtime_error("No gca");
    Py_INCREF(gca);
    PyObject* ax = PyObject_Call(gca, detail::_interpreter::get().s_python_empty_tuple,
        detail::_interpreter::get().s_python_empty_tuple);
